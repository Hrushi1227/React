...
const book_url = "http://localhost:8900/Booking";
            ...
            < div className="container" >
                <div className="panel panel-info">
                    ...
                    <div className="panel-body">
                        ...
                        <div className="form-group">
                            <label>Count</label>
                            <select name="count" value={this.state.count} className="form-control" onChange={this.handleChange}>
                        ...
                        <button className="btn btn-success" onClick={this.handleSubmit}>Place Booking</button>
